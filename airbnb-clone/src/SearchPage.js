    ...
    return (
        <div className='searchpage'>
          ...
          <SearchResult
            ...
            description="2 guest - 3 bedroom - 1 bed - 1.5 . 1.5 shared bathroom - wifi - kitchen"
            star={4.3}
            price="£40 /night"
            total="£157 total"
            />
            <SearchResult
            img="https://cf.bstatic.com/images/hotel/max1024x768/198/198650370.jpg"
            location="Private room in center of London"
           ...
           description="3 guest - 1 bedroom - 1 bed - 1.5 shared bathroom - wifi - free parking - Dry Cleaning"
           star={5.0}
           price="£60 / night"
           total="£450 total"
        />
